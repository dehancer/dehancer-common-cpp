...
namespace Exiv2 {
    ...
    extern const TagVocabulary infoTags[] =  {
        {   "AGES", "MLutXmp.video.Rated" },
        {   "CMNT", "MLutXmp.video.Comment" },
        {   "CODE", "MLutXmp.video.EncodedBy" },
        {   "COMM", "MLutXmp.video.Comment" },
        {   "DIRC", "MLutXmp.video.Director" },
        {   "DISP", "MLutXmp.audio.SchemeTitle" },
        {   "DTIM", "MLutXmp.video.DateTimeOriginal" },
        {   "GENR", "MLutXmp.video.Genre" },
        {   "IARL", "MLutXmp.video.ArchivalLocation" },
        {   "IART", "MLutXmp.video.Artist" },
        {   "IAS1", "MLutXmp.video.Edit1" },
        {   "IAS2", "MLutXmp.video.Edit2" },
        {   "IAS3", "MLutXmp.video.Edit3" },
        {   "IAS4", "MLutXmp.video.Edit4" },
        {   "IAS5", "MLutXmp.video.Edit5" },
        {   "IAS6", "MLutXmp.video.Edit6" },
        {   "IAS7", "MLutXmp.video.Edit7" },
        {   "IAS8", "MLutXmp.video.Edit8" },
        {   "IAS9", "MLutXmp.video.Edit9" },
        {   "IBSU", "MLutXmp.video.BaseURL" },
        {   "ICAS", "MLutXmp.audio.DefaultStream" },
        {   "ICDS", "MLutXmp.video.CostumeDesigner" },
        {   "ICMS", "MLutXmp.video.Commissioned" },
        {   "ICMT", "MLutXmp.video.Comment" },
        {   "ICNM", "MLutXmp.video.Cinematographer" },
        {   "ICNT", "MLutXmp.video.Country" },
        {   "ICOP", "MLutXmp.video.Copyright" },
        {   "ICRD", "MLutXmp.video.DateTimeDigitized" },
        {   "ICRP", "MLutXmp.video.Cropped" },
        {   "IDIM", "MLutXmp.video.Dimensions" },
        {   "IDPI", "MLutXmp.video.DotsPerInch" },
        {   "IDST", "MLutXmp.video.DistributedBy" },
        {   "IEDT", "MLutXmp.video.EditedBy" },
        {   "IENC", "MLutXmp.video.EncodedBy" },
        {   "IENG", "MLutXmp.video.Engineer" },
        {   "IGNR", "MLutXmp.video.Genre" },
        {   "IKEY", "MLutXmp.video.PerformerKeywords" },
        {   "ILGT", "MLutXmp.video.Lightness" },
        {   "ILGU", "MLutXmp.video.LogoURL" },
        {   "ILIU", "MLutXmp.video.LogoIconURL" },
        {   "ILNG", "MLutXmp.video.Language" },
        {   "IMBI", "MLutXmp.video.InfoBannerImage" },
        {   "IMBU", "MLutXmp.video.InfoBannerURL" },
        {   "IMED", "MLutXmp.video.Medium" },
        {   "IMIT", "MLutXmp.video.InfoText" },
        {   "IMIU", "MLutXmp.video.InfoURL" },
        {   "IMUS", "MLutXmp.video.MusicBy" },
        {   "INAM", "MLutXmp.video.Title" },
        {   "IPDS", "MLutXmp.video.ProductionDesigner" },
        {   "IPLT", "MLutXmp.video.NumOfColors" },
        {   "IPRD", "MLutXmp.video.Product" },
        {   "IPRO", "MLutXmp.video.ProducedBy" },
        {   "IRIP", "MLutXmp.video.RippedBy" },
        {   "IRTD", "MLutXmp.video.Rating" },
        {   "ISBJ", "MLutXmp.video.Subject" },
        {   "ISFT", "MLutXmp.video.Software" },
        {   "ISGN", "MLutXmp.video.SecondaryGenre" },
        {   "ISHP", "MLutXmp.video.Sharpness" },
        {   "ISRC", "MLutXmp.video.Source" },
        {   "ISRF", "MLutXmp.video.SourceForm" },
        {   "ISTD", "MLutXmp.video.ProductionStudio" },
        {   "ISTR", "MLutXmp.video.Starring" },
        {   "ITCH", "MLutXmp.video.Technician" },
        {   "IWMU", "MLutXmp.video.WatermarkURL" },
        {   "IWRI", "MLutXmp.video.WrittenBy" },
        {   "LANG", "MLutXmp.video.Language" },
        {   "LOCA", "MLutXmp.video.LocationInfo" },
        {   "PRT1", "MLutXmp.video.Part" },
        {   "PRT2", "MLutXmp.video.NumOfParts" },
        {   "RATE", "MLutXmp.video.Rate" },
        {   "STAR", "MLutXmp.video.Starring" },
        {   "STAT", "MLutXmp.video.Statistics" },
        {   "TAPE", "MLutXmp.video.TapeName" },
        {   "TCDO", "MLutXmp.video.EndTimecode" },
        {   "TCOD", "MLutXmp.video.StartTimecode" },
        {   "TITL", "MLutXmp.video.Title" },
        {   "TLEN", "MLutXmp.video.Length" },
        {   "TORG", "MLutXmp.video.Organization" },
        {   "TRCK", "MLutXmp.video.TrackNumber" },
        {   "TURL", "MLutXmp.video.URL" },
        {   "TVER", "MLutXmp.video.SoftwareVersion" },
        {   "VMAJ", "MLutXmp.video.VegasVersionMajor" },
        {   "VMIN", "MLutXmp.video.VegasVersionMinor" },
        {   "YEAR", "MLutXmp.video.Year" }
    };
    ...
    extern const TagDetails nikonAVITags[] =  {
        {   0x0003, "MLutXmp.video.Make" },
        {   0x0004, "MLutXmp.video.Model" },
        {   0x0005, "MLutXmp.video.Software" },
        {   0x0006, "MLutXmp.video.Equipment" },
        {   0x0007, "MLutXmp.video.Orientation" },
        {   0x0008, "MLutXmp.video.ExposureTime" },
        {   0x0009, "MLutXmp.video.FNumber" },
        {   0x000a, "MLutXmp.video.ExposureCompensation" },
        {   0x000b, "MLutXmp.video.MaxApertureValue" },
        {   0x000c, "MLutXmp.video.MeteringMode" },
        {   0x000f, "MLutXmp.video.FocalLength" },
        {   0x0010, "MLutXmp.video.XResolution" },
        {   0x0011, "MLutXmp.video.YResolution" },
        {   0x0012, "MLutXmp.video.ResolutionUnit" },
        {   0x0013, "MLutXmp.video.DateTimeOriginal" },
        {   0x0014, "MLutXmp.video.DateTimeDigitized" },
        {   0x0016, "MLutXmp.video.duration" },
        {   0x0018, "MLutXmp.video.FocusMode" },
        {   0x001b, "MLutXmp.video.DigitalZoomRatio" },
        {   0x001d, "MLutXmp.video.ColorMode" },
        {   0x001e, "MLutXmp.video.Sharpness" },
        {   0x001f, "MLutXmp.video.WhiteBalance" },
        {   0x0020, "MLutXmp.video.ColorNoiseReduction" }
    };
...
namespace Exiv2 {
    ...
    void RiffVideo::readMetadata()
    {
        ...
        xmpData_["MLutXmp.video.FileSize"] = (double)io_->size()/(double)1048576;
        xmpData_["MLutXmp.video.FileName"] = io_->path();
        xmpData_["MLutXmp.video.MimeType"] = mimeType();
        ...
        xmpData_["MLutXmp.video.Container"] = buf.pData_;

        io_->read(buf.pData_, bufMinSize);
        io_->read(buf.pData_, bufMinSize);
        xmpData_["MLutXmp.video.FileType"] = buf.pData_;
    ...
    void RiffVideo::dateTimeOriginal(long size, int i)
    {
        ...
        if(!i)
            xmpData_["MLutXmp.video.DateUTC"] = buf.pData_;
        else
            xmpData_["MLutXmp.video.StreamName"] = buf.pData_;
        io_->seek(cur_pos + size, BasicIo::beg);
    ...
    void RiffVideo::odmlTagsHandler()
    {
        ...
        while(size > 0) {
            ...
            if(equalsRiffTag(buf,"DMLH")) {
                io_->read(buf.pData_, 4); size -= 4;
                io_->read(buf.pData_, 4); size -= 4;
                xmpData_["MLutXmp.video.TotalFrameCount"] = Exiv2::getULong(buf.pData_, littleEndian);
            }
        }
            ...
            if(equalsRiffTag(buf, "NCVR")) {
                while((long)temp > 3) {
                    ...
                    if(tagID == 0x0001) {
                        ...
                        xmpData_["MLutXmp.video.MakerNoteType"] = buf.pData_;
                        }
                    }
                        ...
                        xmpData_["MLutXmp.video.MakerNoteVersion"] = str;
                    }
                }
            }
    ...
    void RiffVideo::junkHandler(long size)
    {
        ...
        if(equalsRiffTag(buf, "PENT")) {
            ...
            xmpData_["MLutXmp.video.Make"] = buf.pData_;

            io_->read(buf.pData_, 50);
            xmpData_["MLutXmp.video.Model"] = buf.pData_;

            std::memset(buf.pData_, 0x0, buf.size_);
            io_->read(buf.pData_, 8);
            buf2.pData_[0] = buf.pData_[4]; buf2.pData_[1] = buf.pData_[5];
            buf2.pData_[2] = buf.pData_[6]; buf2.pData_[3] = buf.pData_[7];
            xmpData_["MLutXmp.video.FNumber"] = (double)Exiv2::getLong(buf.pData_, littleEndian) / (double)Exiv2::getLong(buf2.pData_, littleEndian);;

            io_->seek(cur_pos + 131, BasicIo::beg);
            io_->read(buf.pData_, 26);
            xmpData_["MLutXmp.video.DateTimeOriginal"] = buf.pData_;

            io_->read(buf.pData_, 26);
            xmpData_["MLutXmp.video.DateTimeDigitized"] = buf.pData_;
        ...
        */
            ...
            io_->read(buf.pData_, size);
            xmpData_["MLutXmp.video.Junk"] = buf.pData_;
        }
    ...
    void RiffVideo::aviHeaderTagsHandler(long size)
    {
        ...
        for(int i = 0; i <= 9; i++) {
            ...
            switch(i) {
            case frameRate:
                xmpData_["MLutXmp.video.MicroSecPerFrame"] = Exiv2::getULong(buf.pData_, littleEndian);
                frame_rate = (double)1000000/(double)Exiv2::getULong(buf.pData_, littleEndian);
                break;
            case (maxDataRate):
                xmpData_["MLutXmp.video.MaxDataRate"] = (double)Exiv2::getULong(buf.pData_, littleEndian)/(double)1024;
                break;
            case frameCount:
                xmpData_["MLutXmp.video.FrameCount"] = Exiv2::getULong(buf.pData_, littleEndian);
                frame_count = Exiv2::getULong(buf.pData_, littleEndian);
                break;
            case streamCount:
                xmpData_["MLutXmp.video.StreamCount"] = Exiv2::getULong(buf.pData_, littleEndian);
                break;
            case imageWidth_h:
                width = Exiv2::getULong(buf.pData_, littleEndian);
                pixelWidth_ = width;
                xmpData_["MLutXmp.video.Width"] = width;
                break;
            case imageHeight_h:
                height = Exiv2::getULong(buf.pData_, littleEndian);
                pixelHeight_ = height;
                xmpData_["MLutXmp.video.Height"] = height;
                break;
            }
        }
        ...
        for(int i=1; i<=25; i++) {
            ...
            case codec:
                if(streamType_ == Video)
                    xmpData_["MLutXmp.video.Codec"] = buf.pData_;
                else if (streamType_ == Audio)
                    xmpData_["MLutXmp.audio.Codec"] = buf.pData_;
                else
                    xmpData_["MLutXmp.video.Codec"] = buf.pData_;
                break;
            case sampleRate:
            ...
            case (sampleRate+1):
                if(streamType_ == Video)
                    xmpData_["MLutXmp.video.FrameRate"] = returnSampleRate(buf,divisor);
                else if (streamType_ == Audio)
                    xmpData_["MLutXmp.audio.SampleRate"] = returnSampleRate(buf,divisor);
                else
                     xmpData_["MLutXmp.video.StreamSampleRate"] = returnSampleRate(buf,divisor);
                break;
            case sampleCount:
                if(streamType_ == Video)
                    xmpData_["MLutXmp.video.FrameCount"] = Exiv2::getULong(buf.pData_, littleEndian);
                else if (streamType_ == Audio)
                    xmpData_["MLutXmp.audio.SampleCount"] = Exiv2::getULong(buf.pData_, littleEndian);
                else
                    xmpData_["MLutXmp.video.StreamSampleCount"] = Exiv2::getULong(buf.pData_, littleEndian);
                break;
            case quality:
                if(streamType_ == Video)
                    xmpData_["MLutXmp.video.VideoQuality"] = Exiv2::getULong(buf.pData_, littleEndian);
                else if(streamType_ != Audio)
                    xmpData_["MLutXmp.video.StreamQuality"] = Exiv2::getULong(buf.pData_, littleEndian);
                break;
            case sampleSize:
                if(streamType_ == Video)
                    xmpData_["MLutXmp.video.VideoSampleSize"] = Exiv2::getULong(buf.pData_, littleEndian);
                else if(streamType_ != Audio)
                    xmpData_["MLutXmp.video.StreamSampleSize"] = Exiv2::getULong(buf.pData_, littleEndian);
                break;
            }
    ...
    void RiffVideo::streamFormatHandler(long size)
    {
        ...
        if(streamType_ == Video) {
            ...
            for(int i = 0; i <= 9; i++) {
                ...
                case planes:
                    io_->read(buf.pData_, 2);
                    xmpData_["MLutXmp.video.Planes"] = Exiv2::getUShort(buf.pData_, littleEndian); break;
                case bitDepth:
                    io_->read(buf.pData_, 2);
                    xmpData_["MLutXmp.video.PixelDepth"] = Exiv2::getUShort(buf.pData_, littleEndian); break;
                case compression:
                    io_->read(buf.pData_, bufMinSize);
                    xmpData_["MLutXmp.video.Compressor"] = buf.pData_; break;
                case imageLength:
                    io_->read(buf.pData_, bufMinSize);
                    xmpData_["MLutXmp.video.ImageLength"] = Exiv2::getULong(buf.pData_, littleEndian); break;
                case pixelsPerMeterX:
                    io_->read(buf.pData_, bufMinSize);
                    xmpData_["MLutXmp.video.PixelPerMeterX"] = Exiv2::getULong(buf.pData_, littleEndian); break;
                case pixelsPerMeterY:
                    io_->read(buf.pData_, bufMinSize);
                    xmpData_["MLutXmp.video.PixelPerMeterY"] = Exiv2::getULong(buf.pData_, littleEndian); break;
                case numColors:
                    io_->read(buf.pData_, bufMinSize);
                    if(Exiv2::getULong(buf.pData_, littleEndian) == 0) {
                        xmpData_["MLutXmp.video.NumOfColours"] = "Unspecified";
                    }
                    else {
                        xmpData_["MLutXmp.video.NumOfColours"] = Exiv2::getULong(buf.pData_, littleEndian);
                    }
                    break;
                case numImportantColors:
                    io_->read(buf.pData_, bufMinSize);
                    if(Exiv2::getULong(buf.pData_, littleEndian)) {
                        xmpData_["MLutXmp.video.NumIfImpColours"] = Exiv2::getULong(buf.pData_, littleEndian);
                    }
                    else {
                        xmpData_["MLutXmp.video.NumOfImpColours"] = "All";
                    }
                    break;
                }
            }
            ...
            for(int i = 0; i <= 7; i++) {
                ...
                case encoding:
                    ...
                    if(td) {
                        xmpData_["MLutXmp.audio.Compressor"] = exvGettext(td->label_);
                    }
                    else {
                        xmpData_["MLutXmp.audio.Compressor"] = Exiv2::getUShort(buf.pData_, littleEndian);
                    }
                    break;
                case numberOfChannels:
                    c = Exiv2::getUShort(buf.pData_, littleEndian);
                    if(c == 1) xmpData_["MLutXmp.audio.ChannelType"] = "Mono";
                    else if(c == 2) xmpData_["MLutXmp.audio.ChannelType"] = "Stereo";
                    else if(c == 5) xmpData_["MLutXmp.audio.ChannelType"] = "5.1 Surround Sound";
                    else if(c == 7) xmpData_["MLutXmp.audio.ChannelType"] = "7.1 Surround Sound";
                    else xmpData_["MLutXmp.audio.ChannelType"] = "Mono";
                    break;
                case audioSampleRate:
                    xmpData_["MLutXmp.audio.SampleRate"] = Exiv2::getUShort(buf.pData_, littleEndian);
                    break;
                case avgBytesPerSec:
                    xmpData_["MLutXmp.audio.SampleType"] = Exiv2::getUShort(buf.pData_, littleEndian);
                    break;
                case bitsPerSample:
                    xmpData_["MLutXmp.audio.BitsPerSample"] = Exiv2::getUShort(buf.pData_,littleEndian);
                    io_->read(buf.pData_, 2);
                    break;
                }
            }
    ...
    void RiffVideo::fillAspectRatio(long width, long height)
    {
        ...
        xmpData_["MLutXmp.video.AspectRatio"] = aspectRatio;

        int aR = (int) ((aspectRatio*10.0)+0.1);

        switch  (aR) {
            case 13 : xmpData_["MLutXmp.video.AspectRatio"] = "4:3"     ; break;
            case 17 : xmpData_["MLutXmp.video.AspectRatio"] = "16:9"    ; break;
            case 10 : xmpData_["MLutXmp.video.AspectRatio"] = "1:1"     ; break;
            case 16 : xmpData_["MLutXmp.video.AspectRatio"] = "16:10"   ; break;
            case 22 : xmpData_["MLutXmp.video.AspectRatio"] = "2.21:1"  ; break;
            case 23 : xmpData_["MLutXmp.video.AspectRatio"] = "2.35:1"  ; break;
            case 12 : xmpData_["MLutXmp.video.AspectRatio"] = "5:4"     ; break;
            default : xmpData_["MLutXmp.video.AspectRatio"] = aspectRatio;break;
        }
    ...
    void RiffVideo::fillDuration(double frame_rate, long frame_count)
    {
        ...
        xmpData_["MLutXmp.video.FileDataRate"] = (double)io_->size()/(double)(1048576*duration);
        xmpData_["MLutXmp.video.Duration"] = duration; //Duration in number of seconds
