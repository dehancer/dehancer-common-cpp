...
public:
    ...
    */
    ...
    //!@name Handling parse_json errors
    //!@{
    ...
    //! Implicit conversion to get the last parse_json result
#ifndef __clang // -Wdocumentation
    /*! \return \ref ParseResult of the last parse_json operation

        \code
          Document doc;
          ParseResult ok = doc.Parse(json);
          if (!ok)
            printf( "JSON parse_json error: %s (%u)\n", GetParseError_En(ok.Code()), ok.Offset());
        \endcode
     */
#endif
...
public:
    ...
    SizeType Size() const { return value_.GridInfo(); }
